...
Process job URLs accumulated in `data/pipeline.md`. The user adds URLs whenever they want and then runs `/career-ops pipeline` to process them all in one batch.
...
## Smart JD extraction from a URL
