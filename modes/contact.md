...
2. **Classify contact type** -- ask the candidate or infer from context:
   ...
   - **Hiring Manager** -- the person leading the team that's hiring
...
3. **Select primary target**: the person who would benefit most from having the candidate on the team
...
4. **Generate the message** using a 3-sentence framework adapted to the contact type:
   ...
   - **Sentence 2 (Proof)**: Largest quantifiable achievement that shows the candidate has solved similar problems
...
5. **Versions**:
   - EN (default)
   - Other language only if the company is non-English-native and the candidate confirms

6. **Alternate targets** with reasoning for why they are good second choices
